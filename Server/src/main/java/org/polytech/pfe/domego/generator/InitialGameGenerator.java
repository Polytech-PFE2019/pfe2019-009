...
public class InitialGameGenerator implements GameGenerator {
    ...
    private Activity generateFirstActivity(){
        ...
        return new BuyingResourcesActivity(1,2,title, description,payResourcesList, riskAccessor.getNRisksCardByActivityID(2, 1), buyResourcesList);
    }
    ...
    private Activity generateSecondActivity(){
        ...
        return new ClassicActivity(2,15,title,description,payResourcesList,riskAccessor.getNRisksCardByActivityID(2, 2));
    }
